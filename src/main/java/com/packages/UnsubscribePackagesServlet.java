...
public class UnsubscribePackagesServlet extends HttpServlet {
    
    private final String deleteSql = "DELETE FROM user_package WHERE package_id = ?";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (rowsAffected > 0) {
				...
				String error = "Error while unsubscribing from package, please try again";
