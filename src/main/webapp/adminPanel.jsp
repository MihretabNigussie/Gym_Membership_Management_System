...
<%
    ...
    <div class="container mt-5">
        <h1 class="text-center mb-4">Create Package</h1>

        <form action="PackageRegisterServlet" method="post" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="packageDescription" name= "packageDescription" rows="5" placeholder="Enter package description"
                    required></textarea>
            </div>
            ...
            <div class="mb-3">
        <label for="packagePicture" class="form-label">Package Picture</label>
        <input type="file" class="form-control" name="packagePicture" id="packagePicture">
    </div>

			
            <button type="submit" class="btn btn-secondary w-100 mb-3">Create Package</button>
        </form>
    </div>
    </main>
